<template>
  <div>
    ...
    <div class="avenir pa3 pa5-m pa5-l pa5-ns mb3 cf bb b--black-05">
      <div class="fl w-100 w-100-m w-80-l w-80-ns">
        <article class="cf">
          <header class="fn fl-ns w-30-ns pr4-ns">
            <h1 class="f2 lh-title fw9 mb3 mt0 pt3 bt bw2">2012–Present</h1>
        ...
        <article>
          ...
          <ul>
            <li>Acted as project manager for development of an archival site, which houses XML content from over 100 years of
              lectures on natural theology.</li>
